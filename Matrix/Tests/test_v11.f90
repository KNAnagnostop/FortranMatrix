...
!m1 = Matrix('g',m,n,is,js,name='m1',mtype='ZH') ;call m1 % print(stdout,fmt='F12.3',form=form);
!m2 = Matrix('g',n,m,js,is,name='m2',mtype='ZH') ;call m2 % print(stdout,fmt='F12.3',form=form);
!m3 = Matrix(    m,m,is,is,name='m3') 
!v2 = Vector('g',n,is,name='v2'); v3 = Vector(m,js,name='v3');
!v4 = Vector('g',m,js,name='v4'); v5 = Vector(n,is,name='v5');
!call mmmult(m1,m2,m3)
!call m3 % print(stdout,fmt='F12.3',form=form);
!print *,'m1*m2: ',norm(m3 - m1*m2)
!call mvmult(m1,v2,v3)
!call v3 % print(stdout,fmt='F12.3',form=form);
!print *,'m1*v2: ',norm(v3 -m1*v2)
!call vmmult(v4,m1,v5)
!call v5 % print(stdout,fmt='F12.3',form=form);
!print *,'v4*m2: ',norm(v5 -v4*m1)
!-----------------------------------------------------------------------------------------------------------------------------------
!m=49;n=m;is=258;js=123;if(m<10) then; form='d';else;form='i';end if
!d1 =DMatrix('g',m,n,is,js,name='d1',mtype='DS') ;call d1 % print(stdout,fmt='F12.3',form=form);
!d2 =DMatrix('g',n,m,js,is,name='d2',mtype='DS') ;call d2 % print(stdout,fmt='F12.3',form=form);
!d3 =DMatrix(    m,m,is,is,name='d3')
!u2 =DVector('g',n,is,name='u2'); u3 =DVector(m,js,name='u3');
!u4 =DVector('g',m,js,name='u4'); u5 =DVector(n,is,name='u5');

!call mmmult(d1,d2,d3)
!call d3 % print(stdout,fmt='F12.3',form=form);
!print *,'d1*d2: ',norm(d3 - d1*d2)

!call mvmult(d1,u2,u3)
!call u3 % print(stdout,fmt='F12.3',form=form);
!print *,'d1*u2: ',norm(u3 -d1*u2)

!call vmmult(u4,d1,u5)
!call u5 % print(stdout,fmt='F12.3',form=form);
!print *,'u4*d1: ',norm(u5 -u4*d1)
